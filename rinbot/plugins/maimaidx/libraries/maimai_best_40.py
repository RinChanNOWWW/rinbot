...
class DrawBest(object):
    ...
    def __init__(self, sdBest: BestList, dxBest: BestList, userName: str, playerRating: int, musicRating: int):
        ...
        self.pic_dir = 'rinbot/plugins/maimaidx/assets/static/mai/pic/'
        self.cover_dir = 'rinbot/plugins/maimaidx/assets/static/mai/cover/'
        self.img = Image.open(
    ...
    def _drawBestList(self, img: Image.Image, sdBest: BestList, dxBest: BestList):
        ...
        titleFontName = 'rinbot/plugins/maimaidx/assets/static/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype(
                'rinbot/plugins/maimaidx/assets/static/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text(
                (8, 44), f'Base: {chartInfo.ds} -> {chartInfo.ra}', 'white', font)
            font = ImageFont.truetype(
                'rinbot/plugins/maimaidx/assets/static/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype(
            'rinbot/plugins/maimaidx/assets/static/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype(
            'rinbot/plugins/maimaidx/assets/static/adobe_simhei.otf', 14, encoding='utf-8')
